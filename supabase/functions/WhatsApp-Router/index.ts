...
- موضوع المدن (بدل سؤال المطار):
  ...
  🕋 **تسلسل أسئلة العمرة (سؤال واحد كل رد، وتخطّ فورًا أي معلومة أعطاها العميل — راجع السجل قبل كل سؤال):**
    ...
    : "(د) **توزيع الليالي**: «كم ليلة في مكة، وكم ليلة في المدينة؟» — هذا **التوزيع** لا المجموع؛ ولو قال «كلها مكة» أو «كلها المدينة» فالتوزيع **مكتمل**. ⚠️ سؤال المدة بـ«الليالي/الأيام» فقط — ❌❌ ممنوع منعاً باتاً كلمة «سنة» أو «سنوات» (لا «كم سنة بقاء»!)."}
