...
القواعد:
- destination: واحدة فقط من [فيتنام، ماليزيا، تايلاند، تركيا، روسيا، البوسنة، إندونيسيا، عُمان، جنوب أفريقيا، موريشيوس، العمرة] إن طابقت وجهة مذكورة، وإلا "". 🕋 مهم: أي طلب عمرة/عُمرة/حج/زيارة الحرم/مكة/مكه/المدينة المنورة/الحرمين → destination = "العمرة" (وجهة العمرة تشمل مكة والمدينة معاً).
