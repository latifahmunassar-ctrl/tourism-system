...
- موضوع المدن (بدل سؤال المطار):
  ...
  • 🕋 **استثناء العمرة (مهم):** إذا كان الطلب **عمرة** → الوجهة معروفة تلقائياً (مكة والمدينة / جدة)، فـ❌❌ **ممنوع منعاً باتاً تسأل «من أي مدينة أنت» أو عن الوجهة إطلاقاً**.${isOmani
    ...
    : " ⚠️ رقم هذا العميل **ليس عُمانياً**: ❌❌ ممنوع منعاً باتاً تذكر «صلالة» أو «مسقط» أو تسأل عن المطار إطلاقاً — اتبع القاعدة العامة (لا سؤال مطار)."} باقي الناقص للعمرة: عدد المعتمرين + تاريخ السفر + عدد الأيام (وعدد ليالي مكة/المدينة إن ذكرها).
