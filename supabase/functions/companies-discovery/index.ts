...
const COUNTRY_CITIES: Record<string, string[]> = {
  ...
  IQ: ["بغداد","أربيل","البصرة","النجف","كربلاء","الموصل","السليمانية","كركوك","الناصرية","الحلة","دهوك"],
};
const COUNTRY_NAME: Record<string, string> = { SA:"السعودية", OM:"عُمان", AE:"الإمارات", KW:"الكويت", QA:"قطر", BH:"البحرين", YE:"اليمن", IQ:"العراق" };
...
const PHONE_RULES: Record<string, { cc: string; mobile: string[]; landline: string[]; mobileLen?: number }> = {
  ...
  IQ: { cc:"964", mobile:["7"], landline:["1","2","3","4","5","6"], mobileLen:10 },
};
