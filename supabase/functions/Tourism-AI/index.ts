...
📋 صياغة سطر HOTELS الجديدة (إلزامية — كل العمود الـ 6 يحوي التواريخ):
   اسم الفندق | المنطقة | النجوم نجوم | نوع الغرفة | السعر ريال/ليلة | عدد الليالي ليالي (من YYYY-MM-DD إلى YYYY-MM-DD) | ما يشمل
