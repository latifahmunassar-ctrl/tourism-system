...
⚠️ **هذي أكثر قاعدة يخطئ فيها النظام — التزم بها بدقّة قاتلة:**
  ...
  • سطر فيه كلمة "مشتركة" / "shared" → السعر في الجدول هو **للشخص الواحد**.
    → اضرب: السعر × عدد الأشخاص = الإجمالي.
    → مثال: مشتركة 100 ريال × 4 أشخاص = **400 ريال** ✅

  • سطر فيه كلمة "خاصة" / "private" → السعر في الجدول هو **للسيارة/المجموعة كاملة**.
    → لا تضرب في عدد الأشخاص. اكتب السعر كما هو.
    → مثال: خاصة 600 ريال لـ 4 أشخاص = **600 ريال** ✅ (وليس 600 × 4)
