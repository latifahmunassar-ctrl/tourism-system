...
1) يوم الوصول من المطار (ARRIVAL DAY):
   - يحوي فقط: استقبال من المطار، التوجه للفندق، تسجيل الدخول.
   - ❌ ممنوع منعاً باتاً إضافة جولة سياحية في هذا اليوم.
   - استثناء وحيد: إذا الموظف طلب صراحةً إضافة جولة في يوم الوصول.

2) يوم الانتقال بين المدن (TRANSFER DAY):
   - يحوي فقط: تسجيل الخروج، الانتقال، تسجيل الدخول للمدينة الجديدة.
