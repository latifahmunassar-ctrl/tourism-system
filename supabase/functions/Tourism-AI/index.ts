...
🇲🇾 قاعدة الطيران الداخلي بين مدن ماليزيا — إجبارية:
   ...
   1. كل انتقال بين مدينتين ماليزيتين عبر مطار → **يُسجَّل في قسم FLIGHTS**،
      ...
      <مدينة من> - <مدينة الى> | داخلي | <السعر للمجموعة> ريال (مجموعة) | <عدد الأشخاص> أشخاص | <السعر> ريال
      مثال: Kuala Lumpur - Langkawi | داخلي | 150 ريال (مجموعة) | 2 أشخاص | 150 ريال

   2. السعر يُؤخَذ من الـ Pax tier المناسب لعدد المسافرين (Pax 1-4 / Pax 5 /
      Pax 6-8 / Pax 9-13 / Pax 14+). السعر **للمجموعة كاملة ضمن الـ tier**،
      ❌ لا تضرب في عدد الأشخاص.
      - مثال: مجموعة 3 أشخاص في tier "Pax 1-4 = 150" → الإجمالي 150 ريال
        (وليس 150×3 = 450).
   ...
   3. ⚠️⚠️⚠️ منع التكرار التامّ (الخطأ الأكثر شيوعاً — احذر منه):
      ...
      ✅ مثال صحيح لبرنامج KL → Penang → Langkawi → KL:
        FLIGHTS:
          Kuala Lumpur - Penang | داخلي | 100 ريال (مجموعة) | 2 شخص | 100 ريال
          Penang - Langkawi | داخلي | 150 ريال (مجموعة) | 2 شخص | 150 ريال
          Langkawi - Kuala Lumpur | داخلي | 150 ريال (مجموعة) | 2 شخص | 150 ريال
      ...
      ❌ مثال خاطئ (الذي يقع فيه النظام):
        FLIGHTS:
          Kuala Lumpur - Penang | 100 ريال
        TRANSFERS:
          اليوم 4 | يتم توصيلكم المطار للتوجه الى جزيرة بينانج | Drop | 100 ريال  ← مكرّر! ممنوع!
