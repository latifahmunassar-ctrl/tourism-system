...
🔒🔒 قاعدة ربط اليوم بالمدينة (DAY-CITY BINDING) — صارمة جداً:
   ...
   📋 خوارزمية إلزاميّة قبل كل سطر TOURS:
     ...
     4. اختر فقط من تلك القائمة. ❌ ممنوع الاختيار من قائمة مدينة أخرى.
...
🇲🇾 قاعدة الطيران الداخلي بين مدن ماليزيا — إجبارية:
   ...
   3. ⚠️ FLIGHTS و TRANSFERS مستقلّان — كلاهما إلزاميّ:
      ...
      - **TRANSFERS** = توصيل المطار الأرضي بالسائق:
        أ) Drop من فندق المغادرة إلى مطار المغادرة (مثل: "حضور السائق للتوجة الى
           المطار كوالامبور الداخلي لذهاب الى جزيرة لانكاوي").
        ب) Pickup من مطار الوصول إلى الفندق (مثل: "الاستقبال من مطار لانكاوي
           والتوجه الي الفندق للراحه").
      - **في يوم الانتقال بين مدينتين ماليزيتين، أَدرج الثلاثة معاً**:
        سطر FLIGHTS + سطر TRANSFERS Drop (للمطار) + سطر TRANSFERS Pickup (من المطار).
        كلّها أسعارها مختلفة في الشيت.
