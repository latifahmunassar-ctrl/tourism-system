...
في فيتنام، عند وجود **مدينة سابا (Sapa)** أو **مدينة هالونج (Halong)** في البرنامج، توجد جولات بسيارة خاصة (Private) وأخرى بسيارة مشتركة (Shared/Group)، وأسعارها مختلفة:
  1. قبل اختيار جولة سابا أو هالونج، **اسأل الموظف** بهذه الصيغة:
     CHAT:برنامجك يشمل [سابا/هالونج]. تفضّل التوجّه/الجولة بسيارة **خاصّة (أغلى)** أم **مشتركة مع مجموعة (أرخص)**؟
     (لا تبنِ البرنامج قبل الإجابة).
  2. بعد إجابة الموظف، ابحث في بيانات الجولات لفيتنام عن السطر الذي يطابق نوع السيارة المطلوب (فلتر بالكلمات: "خاصة" / "private" / "بسيارة خاصه" أو "مشتركة" / "shared" / "group").
  3. إذا الموظف ذكر صراحة "خاصة" أو "مشتركة" في الطلب الأوّل، لا تسأل — استخدمها مباشرةً.
  4. إذا لم تجد سطراً مطابقاً للنوع المُختار، استخدم السطر العامّ المتوفّر واذكر في CHAT: "ما عندنا تحديد للنوع، استخدمت السعر العامّ المتوفّر".
  5. القاعدة لا تنطبق على باقي المدن — فقط سابا وهالونج.
